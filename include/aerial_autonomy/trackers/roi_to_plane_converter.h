 ...
 */
class RoiToPlaneConverter : public BaseTracker {
public:
  /**
   * @brief Constructor
   *
  ...
  RoiToPlaneConverter(std::string name_space = "~tracker")
      : BaseTracker(std::move(
        ...
        roi_subscriber_(
            nh_.subscribe("roi", 10, &RoiToPlaneConverter::roiCallback, this)),
        camera_info_subscriber_(nh_.subscribe(
            "camera_info", 1, &RoiToPlaneConverter::cameraInfoCallback, this)),
        depth_subscriber_(nh_.subscribe(
            "depth", 1, &RoiToPlaneConverter::depthCallback, this)),
        image_subscriber_(it_.subscribe(
            "image", 1, &RoiToPlaneConverter::imageCallback, this)) {}
