...
*/
class MinimumSnapReferenceTrajectoryYaw
...
public:
  ...
  *
  */
  MinimumSnapReferenceTrajectoryYaw(const int &der_order_in,
                                 const Eigen::VectorXd &tau_vec_in,
                                 const Eigen::MatrixXd &path_in, double yaw = 0)
  ...
  *
  */
  MinimumSnapReferenceTrajectoryYaw(
      const MinimumSnapReferenceTrajectoryConfig &ref_config, double yaw = 0)
  ...
  */
  std::pair<ParticleStateYaw, Snap> atTime(double t) const {
    ...
    return std::pair<ParticleStateYaw, Snap>(ParticleStateYaw(p, v, a, j,goal_yaw_), snap);
  }
  ...
  */
  ParticleStateYaw goal(double) {
    ...
    Acceleration a(states_eigen(2, 0), states_eigen(2, 1), states_eigen(2, 2));
    Jerk j(states_eigen(3, 0), states_eigen(3, 1), states_eigen(3, 2));
    return ParticleStateYaw(p, v, a, j,goal_yaw_);
  }
