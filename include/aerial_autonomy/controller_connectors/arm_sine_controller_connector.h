...
class ArmSineControllerConnector
    : public ControllerConnector<EmptySensor, EmptyGoal, std::vector<double>> {

  /**
  * @brief  typedef for parent class
  */
  using BaseConnector =
      ControllerConnector<EmptySensor, EmptyGoal, std::vector<double>>;
...
protected:
  ...
  */
   ...
   */
  virtual void sendControllerCommands(std::vector<double> controls);
