  ...
  */
  std::string getSystemStatus() const {
    ...
    sprintf(buffer,
            ...
            "Goalvx: %2.2f\tGoalvy: %2.2f\tGoalvz: %2.2f\n"
            "Goalx: %2.2f\tGoaly: %2.2f\tGoalz: %2.2f\n"
            ...
            data.velocity_goal.z, data.position_goal.x, data.position_goal.y,
            data.position_goal.z, data.mass, data.timestamp,
