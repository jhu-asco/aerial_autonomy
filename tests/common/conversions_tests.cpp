...
TEST(OmegaToRpyDot, Singularity) {
  ...
  Eigen::Vector3d rpydot_clamped = conversions::omegaToRpyDot(omega, rpy);
  test_utils::ASSERT_VEC_NEAR(rpydot, rpydot_clamped);
}

TEST(OmegaToRpyDot, FiniteDiff) {
