...
TEST(RelativePoseControllerTests, Constructor) {
  PoseControllerConfig config;
  ASSERT_NO_THROW(new RelativePoseController(config));
}

TEST(RelativePoseControllerTests, ConvergedNoOffset) {
  PoseControllerConfig config;
  RelativePoseController controller(config);
...
TEST(RelativePoseControllerTests, NotConvergedNoOffset) {
  PoseControllerConfig config;
  RelativePoseController controller(config);
...
TEST(RelativePoseControllerTests, ConvergedOffset) {
  PoseControllerConfig config;
  RelativePoseController controller(config);
...
TEST(RelativePoseControllerTests, NotConvergedOffset) {
  PoseControllerConfig config;
  RelativePoseController controller(config);
