...
#include <aerial_autonomy/state_machines/gripper_pick_place_state_machine.h>
...
int main(int argc, char **argv) {
  ...
  UAVArmSystemHandler<
      GripperPickPlaceStateMachine,
      pick_place_events::PickPlaceEventManager<GripperPickPlaceStateMachine>>
